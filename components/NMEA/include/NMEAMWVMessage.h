...
#ifndef NMEA_MWV_MESSAGE_H
#define NMEA_MWV_MESSAGE_H
...
class NMEAMWVMessage : public NMEAMessage {
    private:
        NMEATenthsUInt16 windAngle;
        NMEARelativeIndicator relativeIndicator;
        NMEATenthsUInt16 windSpeed;
        NMEASpeedUnits windSpeedUnits;
