...
NMEAVDOMessage::NMEAVDOMessage(NMEATalker &talker) : NMEAVDMVDOMessage(talker) {
}

enum NMEAMsgType NMEAVDOMessage::type() const {
...
NMEAVDOMessage *parseVDOMessage(NMEATalker &talker, etl::bit_stream_reader &streamReader,
